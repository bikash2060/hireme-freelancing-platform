document.addEventListener('DOMContentLoaded', function() {
    const priceRangeCheckbox = document.getElementById('is_price_range');
    const rangeFields = document.getElementById('range-price-fields');
    ...
    priceRangeCheckbox.addEventListener('change', toggleBudgetFields);
    
    // If coming back with errors, ensure proper display
    if (priceRangeCheckbox.checked) {
        rangeFields.style.display = 'block';
        singleFields.style.display = 'none';
    }
