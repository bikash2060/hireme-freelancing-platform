document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        contractCards.forEach(card => {
            ...
            const clientName = card.querySelector('.freelancer-info .info-value').textContent.toLowerCase();
            const shouldShow = title.includes(searchTerm) || clientName.includes(searchTerm);
