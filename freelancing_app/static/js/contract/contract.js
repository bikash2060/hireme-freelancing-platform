document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeFileUpload(uploadAreaId, fileInputId, filePreviewId) {
        const uploadArea = document.getElementById(uploadAreaId);
        const fileInput = document.querySelector(`#${uploadAreaId} input[type="file"]`);
    ...
    // Initialize file upload for initial work submission
    initializeFileUpload('uploadArea', 'attachment', 'filePreview');
    
    // Initialize file upload for final work submission
    initializeFileUpload('finalUploadArea', 'final_attachment', 'finalFilePreview');
